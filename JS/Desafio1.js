...
function calcInteres (){
    ...
    confirm(`el valor de su cuota es de $ ${valorf} y el valor total es $ ${valort}`)
}

let valori = parseFloat(prompt("ingrese el valor de su compra a cuotificar: "))

do{
cuotas = parseInt(prompt("ingrese la cantidad de cuotas: 1 3 6 12, tenga en cuenta que en 1 y 3 pagos no tiene recargo, en 6 y 12 tiene recargo del 5%"))
